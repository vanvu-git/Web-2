...
<div class="menu">
  ...
  <?php if($user['ChucVu'] == "QL") {?>
    <li><a href='admin.php?id=tc'><img src='images/home.png'style='width: 20px;'><span style='padding-left: 10px;'>Home</span></a></li>
    <li><a href='admin.php?id=kh'><img src='images/man-user.png'style='width: 20px;'><span style='padding-left: 10px;'>Khách hàng</span></a></li>
    ...
    <li><a href='admin.php?id=tkkh'><img src='images/logout.png'style='width: 20px;'><span style='padding-left: 10px;'>Tài khoản khách hàng</span></a></li>
    <?php } ?>
  </ul> 
</div>
